...
int main()
{
   ...
   // std::cout<<mat<<std::endl;
    ...
    std::cout << "principal component 1 portion of total Variance : " << cov(0,0)/totalVariance * 100 << std::endl;
    std::cout << "principal component 2 portion of total Variance : " << cov(1,1)/totalVariance * 100 << std::endl;
